...
export async function GET(request: NextRequest) {
  try {
    ...
    const transformedProducts = products.map((product) => {
      ...
      const { images: originalImages, _count, price: originalPrice, salePrice: originalSalePrice, ratingAverage, stockQuantity, salesCount, freeShippingThreshold: originalFreeShippingThreshold, defaultShippingCost: originalDefaultShippingCost, ...rest } = product;
