...
export function DashboardClient({ initialStats, initialCartCount }: DashboardClientProps) {
  ...
  const cartBadgeCount = itemCount > 0 ? itemCount : initialCartCount;
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <h1 className="!text-base !font-semibold text-gray-900 ml-3">Dashboard</h1>
            ...
            <div className="max-w-7xl mx-auto pl-2 sm:pl-3 md:pl-4 pr-2">
              <div className="bg-white border border-gray-200 rounded-lg py-3 pl-4 pr-2 -ml-2 sm:-ml-3 md:-ml-4 -mr-2">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link
                    href="/orders"
                    className="!text-xs text-gray-600 hover:text-gray-700 !font-medium flex items-center gap-1 transition-colors -mr-1"
                  >
                      ...
                      <div className="relative mb-1 overflow-visible pr-4">
                        ...
                        {dashboardData.stats.totalOrders > 0 && (
                          <span className="absolute -top-1 right-1 bg-blue-600 text-white text-[9px] font-bold rounded-full min-w-[16px] h-[16px] flex items-center justify-center px-0.5 z-10">
                            {dashboardData.stats.totalOrders > 99
                              ? '99+'
                              : dashboardData.stats.totalOrders}
                          </span>
                        )}
                      </div>
                      <p className="text-[10px] text-gray-700 font-medium text-center leading-tight whitespace-nowrap">
                        Total Order
                      </p>
                    </Link>

                    <Link
                      href="/orders?status=PENDING&paymentStatus=PENDING"
                      ...
                      <div className="relative mb-1 overflow-visible pr-4">
                        ...
                        {dashboardData.stats.belumBayar > 0 && (
                          <span className="absolute -top-1 right-1 bg-yellow-600 text-white text-[9px] font-bold rounded-full min-w-[16px] h-[16px] flex items-center justify-center px-0.5 z-10">
                            {dashboardData.stats.belumBayar > 99
                              ? '99+'
                              : dashboardData.stats.belumBayar}
                          </span>
                        )}
                      </div>
                      <p className="text-[10px] text-gray-700 font-medium text-center leading-tight whitespace-nowrap">
                    ...
                    <Link href="/reviews/my" className="flex flex-col items-center flex-shrink-0 min-w-[70px] sm:min-w-[80px]">
                      <div className="relative mb-1 overflow-visible pr-4">
                        ...
                        {dashboardData.stats.beriPenilaian > 0 && (
                          <span className="absolute -top-1 right-1 bg-yellow-600 text-white text-[9px] font-bold rounded-full min-w-[16px] h-[16px] flex items-center justify-center px-0.5 z-10">
                            {dashboardData.stats.beriPenilaian > 99
                              ? '99+'
                              : dashboardData.stats.beriPenilaian}
                          </span>
                        )}
                      </div>
                      <p className="text-[10px] text-gray-700 font-medium text-center leading-tight whitespace-nowrap">
            ...
            <div className="max-w-7xl mx-auto pl-2 sm:pl-3 md:pl-4 pr-2">
              <div className="bg-white border border-gray-200 rounded-lg py-3 pl-4 pr-2 -ml-2 sm:-ml-3 md:-ml-4 -mr-2 mb-0">
                ...
                <div className="overflow-x-auto -mx-2 px-2 sm:px-4 md:px-6 overflow-y-visible scrollbar-hide">
                  <div className="flex gap-3 sm:gap-4 md:gap-6 lg:gap-8 min-w-max py-1">
                    <Link
                      href="/favorite?from=dashboard"
                      className="flex items-center gap-2 p-1.5 bg-gray-50 border border-gray-200 rounded-lg flex-shrink-0 min-w-[120px] sm:min-w-[140px]"
                    >
                    ...
                    <Link
                      href="/last-viewed?from=dashboard"
                      className="flex items-center gap-2 p-1.5 bg-gray-50 border border-gray-200 rounded-lg flex-shrink-0 min-w-[120px] sm:min-w-[140px]"
                    >
                      <div className="flex-shrink-0">
                      ...
                      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 sticky top-6">
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <label
                            ...
                            className={`inline-flex items-center justify-center font-medium rounded-lg px-4 py-2 text-base transition-all duration-200 border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${
                          ...
                          <p className="text-xs text-gray-500 mt-2 text-center">PNG, JPG, JPEG, GIF, WEBP (max 2MB)</p>
                        </div>
                      </div>
                    </div>
                  </div>
