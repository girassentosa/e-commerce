...
export default function DashboardPage() {
  ...
  return (
    <div className="container mx-auto px-2 sm:px-3 md:px-4 pt-0 pb-4 sm:pb-6 md:pb-8">
      <div className="-mt-2">
        ...
        <div className="w-full mb-6 w-screen -ml-[calc((100vw-100%)/2)]">
          <div className="max-w-7xl mx-auto pl-2 sm:pl-3 md:pl-4 pr-2">
            <div className="pb-6 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-blue-50 py-4 -ml-2 sm:-ml-3 md:-ml-4 -mr-2">
      ...
      <div className="w-full mb-6 w-screen -ml-[calc((100vw-100%)/2)]">
        <div className="max-w-7xl mx-auto pl-2 sm:pl-3 md:pl-4 pr-2">
          <div className="bg-white border border-gray-200 rounded-lg py-6 px-4 -ml-2 sm:-ml-3 md:-ml-4 -mr-2">
            {/* Header */}
      ...
      <div className="w-full w-screen -ml-[calc((100vw-100%)/2)] mb-2 sm:mb-6 md:mb-8">
        <div className="max-w-7xl mx-auto pl-2 sm:pl-3 md:pl-4 pr-2">
          <div className="bg-white border border-gray-200 rounded-lg py-6 px-4 -ml-2 sm:-ml-3 md:-ml-4 -mr-2 mb-0">
            {/* Header */}
            <div className="flex items-center justify-between mb-6">
