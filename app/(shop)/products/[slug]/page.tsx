...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 sticky top-[3.5rem] sm:top-16 z-40">
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-8">
        ...
        <div className="grid lg:grid-cols-[60%_40%] gap-8 mb-12">
          ...
          <div className="space-y-4">
            {/* Main Image */}
            <div className="relative bg-white rounded-xl overflow-hidden border border-gray-200 aspect-square lg:aspect-[4/3]">
